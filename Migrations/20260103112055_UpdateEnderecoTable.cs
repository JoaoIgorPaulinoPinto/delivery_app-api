...
{
    /// <inheritdoc />
    public partial class UpdateEnderecoTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EstabelecimentoCategorium",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstabelecimentoCategorium", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EstabelecimentoCategorium_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EstabelecimentoCategorium_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstabelecimentoCategorium_EstabelecimentoId",
                table: "EstabelecimentoCategorium",
                column: "EstabelecimentoId");

            migrationBuilder.CreateIndex(
                name: "IX_EstabelecimentoCategorium_StatusId",
                table: "EstabelecimentoCategorium",
                column: "StatusId");

            migrationBuilder.AddForeignKey(
                name: "FK_Enderecos_Estado_UfId",
                table: "Enderecos",
                column: "UfId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Enderecos_Municipio_CidadeId",
                table: "Enderecos",
                column: "CidadeId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Enderecos_TipoEndereco_TipoId",
                table: "Enderecos",
                column: "TipoId",
